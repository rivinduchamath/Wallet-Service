...
*/
    ...
    public UserDetails loadUserByUsernameWithoutCredentials(String s) throws UsernameNotFoundException {
        AuthUserDetail customUserDetails = loadUser(s);
        if (customUserDetails != null) {
            customUserDetails.eraseCredentials();
        }
        assert customUserDetails != null;
        return new org.springframework.security.core.userdetails.User(
                customUserDetails.getUsername(), customUserDetails.getPassword(), customUserDetails.getAuthorities()
        );
    }

    private AuthUserDetail loadUser(String name) throws UsernameNotFoundException {
